...
- [ ] ¿Tu endpoint/cambio nuevo requiere autenticación (`middlewares/auth.middleware.ts`)?
      ¿Debería?
- [ ] ¿Valida el input recibido con `zod`? ¿Qué pasa si mandas un valor inválido o vacío?
